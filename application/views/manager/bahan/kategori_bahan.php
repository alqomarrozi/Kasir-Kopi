				...
				<div class="card">
					<div class="card-header">
						...
						<div class="card-title">
							...
							<a href="<?php echo base_url('manager/bahan');?>"
								class="btn btn-dark waves-effect waves-float waves-light btn-sm"><i
									data-feather='list'></i> Semua Bahan & Stok</a>
						</div>
					</div>
						...
						<table id="tablebahan" class="user-list-table table dataTable no-footer dtr-column">
							<thead class="table-light">
								<tr>
									...
									<th>Deskripsi Kategori Bahan</th>
									<th>Dibuat Oleh</th>
									<th>Jumlah Bahan</th>
									<th>Aksi</th>
								</tr>
							...
							<tbody>
								...
								<tr>
									...
									<?php 
                    $query=$this->db->query("SELECT * FROM bahan WHERE bahan_kat_id=".$row->id_kategori."");
                    $jumlah_bahan=$query->num_rows();
              ?>
									<td><?= $jumlah_bahan;?> Bahan</td>
									<td>
										<div class="dropdown">
							...
							<div class="modal-content">
								...
								<div class="modal-body pb-5 px-sm-5 pt-50">
									...
									<form id="editUserForm" class="row gy-1 pt-75"
										action="<?php echo base_url('manager/bahan_kategori/buat_kategori');?>" method="POST">
						...
						<div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
							<div class="modal-content">
								...
								<div class="modal-body pb-5 px-sm-5 pt-50">
									...
									<form action="<?php echo site_url('manager/bahan_kategori/edit_kategori');?>"
					...
					<div class="modal fade" id="DeleteModal" aria-hidden="true" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
							<div class="modal-content">
								...
								<form action="<?php echo site_url('manager/bahan_kategori/delete_kategori');?>"
										class="row gy-1 pt-75" method="post">
