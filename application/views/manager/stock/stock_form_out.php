        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="float-sm-right">
                    <a href="<?= site_url('manager/stock/out') ?>" class="btn btn-info btn-sm"><i class="fa fa-undo"> Back</i></a>
                </div> 
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span> 
                                            <button type="button" class="input-group-text btn btn-info btn-flat form-control" data-bs-toggle="modal" data-bs-target="#modal-item"><i class="fa fa-search" id="basic"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tbody>
                            <?php foreach ($item as $i) { ?> 
                                <tr>
                                    ...
                                    <td><?= $i->stok_bahan; ?></td> 
                                    <td align="center">
                                        <button class="btn btn-xs btn-info" id="select" data-bahan_id="<?= $i->id_bahan; ?>" data-kode_bahan="<?= $i->kode_bahan; ?>" data-nama_bahan="<?= $i->nama_bahan; ?>" data-stok_bahan="<?= $i->stok_bahan; ?>">
