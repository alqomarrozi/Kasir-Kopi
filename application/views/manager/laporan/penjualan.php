    ...
    <div class="card">
        ...
        <div class="col-md-12">
            <div class="card card-info">
                ...
                <div class="card-body"> <?php echo form_open('manager/laporan', array('role' => "form", 'id' => "myForm", 'data-toggle' => "validator")); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-1">
                            ...
                            <a href="<?= base_url('manager/laporan');?>" class="btn btn-sm btn-relief-primary">Reset Filter</a>
                        </div>
