	...
	<div class="content-wrapper container-xxl p-0">
        ...
        if( ! empty($transaksi)){
          ...
          foreach($transaksi as $data){ 
            ...
            echo "<td>".rupiah($pajak)."</td>";
            echo "<td>".rupiah($sub_total)."</td>";
            echo "<td><b>".rupiah($laba)."</b></td>";
            echo "</tr>";
            $no++;
          }
        }
        ?>
         ...
         <td><?php if(! empty($total_modal)){
			  echo rupiah($total_modal) ;
			  }?></td>
         <td><?php if(! empty($total_pajak)){
			  echo rupiah($total_pajak) ;
			  }?></td> 
         <td><?php if(! empty($total_modal)){
			  echo rupiah($total_pemasukan) ;
			  }?></td>
         <td><b><?php if(! empty($total_keuntungan)){
			  echo rupiah($total_keuntungan) ;
			  }?></b></td>
      </tr>      
										</tfoot>
									</table>
