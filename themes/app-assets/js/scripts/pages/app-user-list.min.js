    ...
    "laravel" === $("body").attr("data-framework") && (o = $("body").attr("data-asset-path"), r = o + "app/user/view/account"), s.each((function() {
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, s) {
                var n = a.full_name,
                    l = a.email,
                    i = a.avatar;
                if (i) var c = '<img src="' + o + "images/avatars/" + i + '" alt="Avatar" height="32" width="32">';
                else {
                    var d = ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random()) + 1],
                        p = (n = a.full_name).match(/\b\w/g) || [];
                    c = '<span class="avatar-content">' + (p = ((p.shift() || "") + (p.pop() || "")).toUpperCase()) + "</span>"
                }
                return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar ' + ("" === i ? " bg-light-" + d + " " : "") + ' me-1">' + c + '</div></div><div class="d-flex flex-column"><a href="' + r + '" class="user_name text-truncate text-body"><span class="fw-bolder">' + n + '</span></a><small class="emp_post text-muted">' + l + "</small></div></div>"
            }
        }, {
            targets: 2,
            render: function(e, t, a, s) {
            ...
            render: function(e, t, a, s) {
                var n = a.status;
                return '<span class="badge rounded-pill ' + l[n].class + '" text-capitalized>' + l[n].title + "</span>"
            }
        }, {
            targets: -1,
            title: "Actions",
            ...
            render: function(e, t, a, s) {
                return '<div class="btn-group"><a class="btn btn-sm dropdown-toggle hide-arrow" data-bs-toggle="dropdown">' + feather.icons["more-vertical"].toSvg({
                    class: "font-small-4"
                }) + '</a><div class="dropdown-menu dropdown-menu-end"><a href="' + r + '" class="dropdown-item">' + feather.icons["file-text"].toSvg({
                    class: "font-small-4 me-50"
                }) + 'Details</a><a href="javascript:;" class="dropdown-item delete-record">' + feather.icons["trash-2"].toSvg({
                    class: "font-small-4 me-50"
        ...
        initComplete: function() {
            this.api().columns(2).every((function() {
                var e = this,
                    t = ($('<label class="form-label" for="UserRole">Role</label>').appendTo(".user_role"), $('<select id="UserRole" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Select Role </option></select>').appendTo(".user_role").on("change", (function() {
